...
public class CartDAO implements IcartDAO {
	...
	// 장바구니 페이지에서 수량 수정했을 때
	@Override
	public int cartUpdateProductProcess(String p_code, int p_count, UserDTO userDTO) {
    	String updateQuery = "UPDATE cg_cart SET p_count = ? WHERE p_code = ? AND u_seq = ?";
    	return template.update(updateQuery, p_count, p_code, userDTO.getU_seq());
    }
