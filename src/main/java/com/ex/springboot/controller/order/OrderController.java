...
public class OrderController {
	...
	public int orderInsert(@RequestParam Map<String, Object> orderData) throws JsonMappingException, JsonProcessingException {
		/* playerList로 넘어온 데이터를 문자열로 변환 */
	      ...
	      int result = dao.orderInsertProcess(p_code_arr, p_count_arr);
